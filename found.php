...
<html>
    ...
    <body>
        <header>
            ...
            <h1>What'd ya find?</h1>
            <h2>Start by filling out some forms below to describe the item you've found.</h2>
        </header>

        <form action="iprints.php" method="POST">
        <table>
            <tr>
                <td>What item(s) did you find?</td><td><input type="text" name="item"></td>
            </tr>
            <tr>
                <td>Please provide any other descriptive information about the item(s) that may be helpful in identifying it (eg. color, model, size, etc).</td><td><input type="text" name="info"></td>
            </tr>
        </table>
        <hr>
        <h2>Continue by providing some information as to where and when you found it.</h2>
        <table>
            <tr>
                <td>Where on campus might you have found your item?</td><td>
                    <select name="Action">
            ...
            <tr>
                <td>About when was the item found? (Okay to approximate)</td>
                <td>
                    <select name="Action">
                        <option>1</option>
                        <option>2</option>
       ...
       <hr>
        <h2>Now we need some information about yourself to contact you if the owner claims the item.</h2>
        <table>
            <tr>
                <td>First Name</td>
                <td>
